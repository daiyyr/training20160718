<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="pptyvtmaster.aspx.cs" Inherits="sapp_sms.pptyvtmaster" %>
<%@ Register src="jqGridCC.ascx" tagname="jqGridCC" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - PptyvtMaster</title>
    ...
    <script src="scripts/pptyvtmaster.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDetails"
                runat="server" ImageUrl="Images/detail.gif" PostBackUrl="~/pptyvtmaster.aspx"
        ...
        <div>
            <asp:ImageButton ID="ImageButtonEdit"
                runat="server" ImageUrl="Images/edit.gif" PostBackUrl="~/pptyvtmaster.aspx"
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="~/images/delete.gif" PostBackUrl="~/pptyvtmaster.aspx"
    ...
    <div id="content_middle">
        <div>
            ...
            <uc1:jqGridCC runat="server" ID="jqGridTable" colNames="['ID','Property','Fee']"
             colModel="[
                  ...
                  { name: 'Fee', index: 'Fee', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
              ]"
             rowNum="25"
             ...
             width="700"
             height="500"
             url="pptyvtmaster.aspx/DataGridDataBind"
             hasID="false"
             />
