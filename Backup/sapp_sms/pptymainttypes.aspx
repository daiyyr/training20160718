<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="pptymainttypes.aspx.cs" Inherits="sapp_sms.pptymainttypes" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<%@ Register src="jqGridCC.ascx" tagname="jqGridCC" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - PptymaintTypes</title>
    ...
    <script src="scripts/pptymainttypes.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="~/images/delete.gif" PostBackUrl="~/pptymainttypes.aspx"
    ...
    <div id="content_middle">
        <div>
            ...
            <cc1:jqGridAdv runat="server" ID="jqGridPptymaintTypes" colNames="['ID','Code(*)','Name(*)','Description']"
             colModel="[
             ...
             width="700"
             height="500"
             url="pptymainttypes.aspx/DataGridPptymaintTypesDataBind"
             hasID="false"
             editurl="pptymainttypes.aspx/SaveDataFromGrid"
             inlineNav="true"
             />
