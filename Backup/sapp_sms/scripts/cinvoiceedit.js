...
function searchChartData() {
    ...
    if (findCode == false) {
        ...
        resultContent = "<div style='width:588px; max-height:120px; overflow-y:scroll;'><table cellpadding='0' cellspacing='0' border='1'><thead><tr style='background-color: lightblue;'> <td width='160'>Code</td>  <td width='400'>Name</td> </tr></thead> <tbody>" + resultContent + "</tbody></table></div>";
