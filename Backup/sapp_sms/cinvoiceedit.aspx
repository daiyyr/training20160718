<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="cinvoiceedit.aspx.cs" Inherits="sapp_sms.cinvoiceedit" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Cinvoice Edit</title>
    ...
    <script src="scripts/cinvoiceedit.js" type="text/javascript"></script>
</asp:Content>
    ...
    <div id="content_middle">
        ...
        <table class="details">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxApply" runat="server"></asp:TextBox>
                ...
                <td colspan="4">
                    <div>
                        ...
                        <cc1:jqGridAdv runat="server" ID="jqGridTrans" colNames="['ID','Chart(*)','Description','Net(*)','Tax(*)','Gross(*)','GST']"
                          ...
                          { name: 'Net', index: 'Net', width: 100,   align: 'left', search: true,editable:isCellEditable(),  searchoptions: { sopt: ['cn', 'nc']}},
                          { name: 'Tax', index: 'Tax', width: 100,   align: 'left', search: true, editable:isCellEditable(), searchoptions: { sopt: ['cn', 'nc']}},
                          { name: 'Gross', index: 'Gross', width: 100, editable:isCellEditable(), editrules:{custom:true, custom_func:ValidateRowData}, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
                          {name:'GST',index:'GST', width:60, editable:isCellEditable(), edittype:'checkbox',editoptions: {value:'Yes:No', defaultValue: isGTSChecked() }}
                            ...
                            width="700" height="300" url="cinvoiceedit.aspx/DataGridDataBind" hasID="false"
                            editurl="cinvoiceedit.aspx/SaveDataFromGrid" inlineNav="true" afterRowSave="ChangeTotal"
