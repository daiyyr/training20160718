<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="tableedit.aspx.cs" Inherits="sapp_sms.tableedit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Table Edit</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="details">
        <tr>
            <td><b>Table:</b></td>
            <td colspan="3">
                <b><asp:Label ID="LabelTableID" runat="server" Text="ID"></asp:Label></b>
            </td>
        </tr>
        <tr>
            <td colspan="4"></td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorNumber" runat="server" ErrorMessage="!" ForeColor="Red"
                   ControlToValidate="TextBoxDBName"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="4"></td>
