<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="budgetupload.aspx.cs" Inherits="sapp_sms.budgetupload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_right">
        <div class="button">
            <div class="button-title">Template</div>
            <div>
                <asp:ImageButton ID="ImageButtonTemplate" runat="server" ImageUrl="~/images/levies.gif" onclick="ImageButtonTemplate_Click"  />
            </div>
        </div>
    </div>
</asp:Content>
