<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="crefund.aspx.cs" Inherits="sapp_sms.crefund" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - CRefund</title>
    ...
    <div id="content_left">
        ...
        <div class="button">
            <div class="button-title">
                Edit</div>
            <div>
                <asp:ImageButton ID="ImageButtonEdit" runat="server" ImageUrl="Images/edit.gif" PostBackUrl="~/crefund.aspx"
        ...
        <div>
            ...
            <cc1:jqGridAdv runat="server" ID="jqGridTable" colNames="['ID','Date', 'BodyCorp', 'Creditor','Type','Reference','Gross', 'Allocated', 'Balance']"
              ...
              { name: 'Date', index: 'Date', width: 150, align: 'left', search: true, formatter: 'date', formatoptions:{srcformat: 'd/m/Y'}},
                ...
                viewrecords="true" width="700" height="500" url="crefund.aspx/DataGridDataBind"
                hasID="false" />
        </div>
    </div>
        ...
        <div class="button">
            ...
            <div>
                <asp:ImageButton ID="ImageButtonAllocate" runat="server" ImageUrl="Images/edit.gif"
                    PostBackUrl="~/crefund.aspx" OnClientClick="return ImageButtonAllocate_ClientClick()" />
            </div>
        </div>
    </div>
</asp:Content>
