<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="cinvoicedetails.aspx.cs" Inherits="sapp_sms.cinvoicedetails" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Cinvoice Details</title>
    ...
    <div id="content_middle">
        <table class="details">
            ...
            <tr>
                ...
                <td>
                    <b>Order :</b><asp:Image ID="Image2" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <b>On Charge To Unit :</b><asp:Image ID="Image6" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <b style="display: none;">Paid :</b><asp:Image ID="Image15" runat="server" Height="10px"
                    ...
                    <div>
                        ...
                        <cc1:jqGridAdv runat="server" ID="jqGridTrans" colNames="['ID','Chart(*)','Description','Net(*)','Tax(*)','Gross(*)']"
                          ...
                          { name: 'Gross', index: 'Gross', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
                            ...
                            width="700" height="300" url="cinvoicedetails.aspx/DataGridDataBind" hasID="true"
    ...
    <div id="content_right">
        <div class="button">
            <div class="button-title">
                Purchase Order</div>
            <div>
                <asp:ImageButton ID="ImageButtonOrder" runat="server" ImageUrl="~/images/invoice.gif"
                    OnClick="ImageButtonOrder_Click" />
            </div>
        </div>
        <div class="button">
            <div class="button-title">
