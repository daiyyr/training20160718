<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="purchordertypes.aspx.cs" Inherits="sapp_sms.purchordertypes" %>
     ...
     <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="~/images/delete.gif" PostBackUrl="~/purchordertypes.aspx"
    ...
    <div id="content_middle">
        ...
        <div>
            ...
            <cc1:jqGridAdv runat="server" ID="jqGridTypes" colNames="['ID','Code(*)','Name(*)','Description']"
             ...
             width="700"
             height="500"
             url="purchordertypes.aspx/DataGridDataBind"
             hasID="false"
             editurl="purchordertypes.aspx/SaveDataFromGrid"
             inlineNav="true"
             />
