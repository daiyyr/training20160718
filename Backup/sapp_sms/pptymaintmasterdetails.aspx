<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="pptymaintmasterdetails.aspx.cs" Inherits="sapp_sms.pptymaintmasterdetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="scripts/pptymaintmasterdetails.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_middle">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="LabelType" runat="server" Text=""></asp:Label></td>
            <td><b>Property:</b></td>
            <td>
                &nbsp;<asp:Label ID="LabelProperty" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><b>Contractor:</b><asp:Image ID="Image5" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></td>
            <td>
                &nbsp;<asp:Label ID="LabelCredit" runat="server" Text=""></asp:Label></td>
            <td><b>Unit:</b></td>
            <td>
                &nbsp;<asp:Label ID="LabelUnit" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td colspan="4"><asp:Image ID="Image6" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></td>
        </tr>
        <tr>
            <td><b>Compliance:</b><asp:Image ID="Image7" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></td>
            <td>
                &nbsp;<asp:Label ID="LabelCompliance" runat="server" Text=""></asp:Label></td>
            <td></td><td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><b>Due:</b></td>
            <td>
                &nbsp;<asp:Label ID="LabelDue" runat="server" Text=""></asp:Label></td>
            <td><b>Next Due:</b><asp:Image ID="Image9" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></td>
            <td>
                &nbsp;<asp:Label ID="LabelNextDue" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><b>Freq:</b></td>
            <td>
                &nbsp;<asp:Label ID="LabelFreq" runat="server" Text=""></asp:Label></td>
            <td><b>Freq Type:</b><asp:Image ID="Image11" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></td>
            <td>
                &nbsp;<asp:Label ID="LabelFreqType" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><b>Notes:</b></td>
            <td colspan="3">
                &nbsp;<asp:Label ID="LabelNotes" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
