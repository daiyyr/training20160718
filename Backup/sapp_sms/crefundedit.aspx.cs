...
namespace sapp_sms
{
    public partial class crefundedit : System.Web.UI.Page
    {
        ...
        protected void ImageButtonSave_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                items.Add("cpayment_ctype_id", "2");
                items.Add("cpayment_type_id", AjaxControlUtils.ComboBoxSelectedValueToSQL(ComboBoxType, false));
                items.Add("cpayment_gross", DBSafeUtils.DecimalToSQL(-AdFunction.Rounded(TextBoxGross.Text)));
                ...
                if (mode == "add")
                {
                    ...
                    if (Request.QueryString["cinvoiceid"] != null)
                    {
                        ...
                        allowitems.Add("gl_transaction_net", -AdFunction.Rounded(TextBoxGross.Text));
