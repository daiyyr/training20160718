<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="receiptdetails.aspx.cs" Inherits="sapp_sms.receiptdetails" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Receipt Details</title>
            ...
            <tr>
                <td colspan="4">
                    <div>
                        ...
                        <cc1:jqGridAdv runat="server" ID="jqGridTrans" colNames="['ID','Invoice Num','Description','Date', 'DueDate', 'Net','Tax','Gross','Due','Allocated','Discount']"
                            colModel="[
                        ...
                        { name: 'Due', index: 'Due', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
                            { name: 'Allocated', index: 'Allocated', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
                               { name: 'Discount', index: 'Discount', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                      ]" rowNum="25" rowList="[5, 10, 25, 50, 100]" sortname="InvoiceNum" sortorder="asc"
                            viewrecords="true" width="700" height="300" url="receiptdetails.aspx/DataGridDataBind"
                            hasID="false" />
                    </div>
                    <div>
                    </div>
