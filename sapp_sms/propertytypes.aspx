<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="propertytypes.aspx.cs" Inherits="sapp_sms.propertytypes" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<%@ Register src="jqGridCC.ascx" tagname="jqGridCC" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - PropertyTypes</title>
    ...
    <script src="scripts/propertytypes.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="~/images/delete.gif" PostBackUrl="~/propertytypes.aspx"
    ...
    <div id="content_middle">
        <div>
            ...
            <cc1:jqGridAdv runat="server" ID="jqGridPropertyTypes" colNames="['ID','Code(*)','Name(*)','Description']"
             colModel="[
             ...
             width="700"
             height="500"
             url="propertytypes.aspx/DataGridPropertyTypesDataBind"
             hasID="false"
             editurl="propertytypes.aspx/SaveDataFromGrid"
             inlineNav="true"
             />
