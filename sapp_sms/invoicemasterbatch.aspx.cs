    ...
    public partial class invoicemasterbatch : System.Web.UI.Page, IPostBackEventHandler
    {
        ...
        public static string DataGridDataBind(string postdata)
        {
            try
            {
                ...
                // 26/05/2016 Load DB value of Discount
                ...
                */
                ...
                sql = sql + "                     AND T4.gl_transaction_ref IN ( ";
                sql = sql + "                         SELECT T5.gl_transaction_ref  ";
                sql = sql + "                           FROM gl_transactions as T5 ";
                sql = sql + "                           WHERE T5.gl_transaction_type_id = 6 ";
                sql = sql + "                             AND T5.gl_transaction_bodycorp_id = " + HttpContext.Current.Request.Cookies["bodycorpid"].Value;
                sql = sql + "                             AND T5.gl_transaction_chart_id IN (" + chart_id_general_Levy + ", " + chart_id_discount + ") ";
                sql = sql + "                         ) ";
                /*
                sql = sql + "             select  ";
                sql = sql + "                  T3.invoice_gl_invoice_id,  ";
