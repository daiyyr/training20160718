<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="creditnoteallocate.aspx.cs" Inherits="sapp_sms.creditnoteallocate" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Credit Note Allocate</title>
                ...
                <td colspan="4">
                    ...
                    <div>
                        ...
                        { name: 'Paid', index: 'Paid',  editable:true, editrules:{custom:true, custom_func:ValidateRowData}, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            width="800" height="200" url="creditnoteallocate.aspx/jqGridRelatedDataBind" hasID="false"
                            multiselect="false" editurl="creditnoteallocate.aspx/SaveDataFromGrid" inlineNav="true"
                            addVisible="false" afterRowSave="ChangeCreditNoteAllocate" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4">
                    ...
                    <div>
                        ...
                        { name: 'Due', index: 'Due', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            width="800" height="200" url="creditnoteallocate.aspx/jqGridUnpaidDataBind" hasID="false"
                            multiselect="true" />
                </td>
            </tr>
        </table>
