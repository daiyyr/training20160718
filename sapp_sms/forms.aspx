<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="forms.aspx.cs" Inherits="sapp_sms.forms" %>
<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Forms</title>
    ...
    <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonEdit"
                runat="server" ImageUrl="Images/edit.gif" PostBackUrl="~/forms.aspx"
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="Images/delete.gif" PostBackUrl="~/forms.aspx"
    ...
    <div id="content_middle">
        <div>
            ...
            <cc1:jqGridAdv runat="server" ID="jqGridForms" colNames="['ID', 'Name', 'FileName']"
             ...
             { name: 'FileName', index: 'FileName', width: 100, align: 'left', search: false}]"
             rowNum="25"
             ...
             width="700"
             height="500"
             url="forms.aspx/DataGridFormsDataBind"
             hasID="false"
             />
        </div>
