<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="levies.aspx.cs" Inherits="sapp_sms.levies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_middle">
        ...
        <cc1:jqGridAdv runat="server" ID="jqGridLevies" colNames="['ID','Bodycorp','Date','Description','Total']"
            colModel="[
          ...
          { name: 'Description', index: 'Description', width: 200, editable:false, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
            ...
            width="800" height="500" url="levies.aspx/jqGridLeviesDataBind" hasID="false" />
    </div>
        ...
        <div class="button">
            ...
            <div>
                <asp:ImageButton ID="ImageButtonInvoice" PostBackUrl="~/levies.aspx" runat="server"
                    ImageUrl="~/images/invoice.gif" OnClientClick="return Show_ClientClick()" />
            </div>
        </div>
    </div>
    <script>
