<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="invoiceallocate.aspx.cs" Inherits="sapp_sms.invoiceallocate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="scripts/invoiceallocate.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content_left">
        <div class="button">
            ...
            <div>
                <asp:ImageButton ID="ImageButtonSave" runat="server" ImageUrl="Images/save.gif" OnClick="ImageButtonSave_Click" OnClientClick="return ImageButtonClose_ClientClick();" />
                <asp:HiddenField ID="HiddenHasReceipt" runat="server" ClientIDMode="Static" />
                <asp:HiddenField ID="HiddenMaxDiscount" runat="server" ClientIDMode="Static" />
                <asp:HiddenField ID="HiddenOfferDiscount" runat="server" ClientIDMode="Static" />
            </div>
        </div>
        <div class="button">
            <div class="button-title">
                ...
                <td colspan="4">
                    ...
                    <div>
                        ...
                        { name: 'Due', index: 'Due', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            width="800" height="200" url="invoiceallocate.aspx/jqGridUnpaidDataBind" hasID="false"
                            multiselect="true" />
                </td>
            </tr>
        </table>
