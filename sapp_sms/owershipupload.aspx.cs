            ...
            {
                {
                    ...
                    foreach (DataRow newdr in dt.Rows)
                    {
                        ...
                        if ("".Equals(startdate))
                        {
                            throw new Exception(CsvDT.editErrorMessage(row_idx, "Start", "ownership start date is empty"));
                        }
                        ...
                        else
                        {
                            ...
                            throw new Exception(CsvDT.editErrorMessage(row_idx, "debtor_master_code", "debtor master code [" + newdr["debtor_master_code"].ToString() + "] could not be founf in DB"));
                        }
                    }
                }
                o.Commit();
