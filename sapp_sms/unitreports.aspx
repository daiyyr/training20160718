...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_middle">
        <table class="details">
            <tr>
                <td>
                    <asp:CheckBox ID="CheckBoxUnitList" runat="server" />
                    <b>Unit List Report</b>
                </td>
            </tr>
            <tr>
                <td>
                    <table style="border-width: 0px; border-spacing: 0px; " cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="4" style="border-width: 0px">
                                <asp:CheckBox ID="CheckBoxProprietorStatement" runat="server" /><b>Proprietor Statement Report</b>
                                <asp:DropDownList ID="DropDownUnitList" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
