            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    else
                    {
                        ...
                        string csql = "select count(invoice_master_id) from invoice_master where invoice_master_type_id = 1 AND invoice_master_bodycorp_id=" + HttpContext.Current.Request.Cookies["bodycorpid"].Value + " and invoice_master_batch_id is null";
