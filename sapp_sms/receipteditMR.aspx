<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="receipteditMR.aspx.cs" Inherits="sapp_sms.receipteditMR" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Receipt Edit</title>
    ...
    <script src="scripts/packages/jquery.dataTables.columnFilter.js" type="text/javascript"></script>
    <style type="text/css">
/*
 *  File:         demo_table.css
 *  CVS:          $Id$
    ...
    <div id="content_left">
        <div class="button">
            <div class="button-title">
                History</div>
            <div>
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/history.gif"
        ...
        <div class="button">
            <div class="button-title">
                Template</div>
            <div>
                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/images/history.gif"
    ...
    <div id="content_middle">
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            <table class="details">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDate0" runat="server" ErrorMessage="!"
                            ForeColor="Red" ControlToValidate="TextBoxNotes"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <b>
                            <asp:TextBox ID="TextBoxNotes" runat="server" Height="50px" Width="100%" TextMode="MultiLine"></asp:TextBox>
                        </b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="GridView1" CssClass="JQDataTable" runat="server" AutoGenerateColumns="False"
                            Width="100%" ShowFooter="true">
                            <Columns>
                                <asp:BoundField DataField="bodycorp_code" HeaderText="Bodycorp" />
                                <asp:BoundField DataField="unit_master_code" HeaderText="Unit" />
                                <asp:BoundField DataField="debtor_master_name" HeaderText="Debtor" />
                                <asp:BoundField DataField="OutStanding" HeaderText="Outstanding" />
                                <asp:TemplateField HeaderText="Amount">
                                    <ItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" IID='<%#Eval("unit_master_id") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="AA">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="CheckBox1" runat="server" IID='<%#Eval("unit_master_id") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
