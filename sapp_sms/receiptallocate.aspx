<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="receiptallocate.aspx.cs" Inherits="sapp_sms.receiptallocate" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Receipt Allocate</title>
    ...
    <script src="scripts/receiptallocate.js" type="text/javascript"></script>
</asp:Content>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            <div class="button">
                <div class="button-title">
                    <asp:Label ID="Label1" runat="server" Text="Next"></asp:Label></div>
                <div>
                    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"
                        Width="100%">
                    </asp:DropDownList>
                    <br />
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="Images/goright.gif" OnClick="ImageButton1_Click" />
                </div>
            </div>
            <div class="button">
                <div class="button-title">
                    <asp:Label ID="Label2" runat="server" Text="Submit" Visible="False"></asp:Label></div>
                <div>
        ...
        <table class="details">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <div style="text-align: right;">
                        <b id="10discount">10% Discount</b>
                    </div>
                    <div>
                        <cc1:jqGridAdv runat="server" ID="jqGridRelated" colNames="['ID','RefType','Invoice Num','Description','Date', 'DueDate', 'Net','Tax','Gross','Due','Paid','Discount']"
                            colModel="[
                        ...
                        { name: 'Discount', index: 'Discount', editable:true, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            width="800" height="200" url="receiptallocate.aspx/jqGridRelatedDataBind" hasID="false"
                            multiselect="false" editurl="receiptallocate.aspx/SaveDataFromGrid" inlineNav="true"
            ...
            <tr>
                <td colspan="4" style="text-align: center;">
                    <asp:ImageButton ID="ImageButtonUp" runat="server" PostBackUrl="~/receiptallocate.aspx"
                        OnClientClick="return ImageButtonUp_ClientClick()" ImageUrl="~/images/goup.gif" />
                    <asp:ImageButton ID="ImageButtonDown" runat="server" PostBackUrl="~/receiptallocate.aspx"
                ...
                <td colspan="4">
                    ...
                    <div>
                        ...
                        { name: 'Due', index: 'Due', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            width="800" height="200" url="receiptallocate.aspx/jqGridUnpaidDataBind" hasID="false"
                            multiselect="true" />
                </td>
            </tr>
        </table>
