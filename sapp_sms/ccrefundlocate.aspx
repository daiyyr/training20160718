<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="ccrefundlocate.aspx.cs" Inherits="sapp_sms.ccrefundlocate" %>
<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - CCreditor Refund Alocate.aspx Allocate</title>
    ...
    <script src="scripts/ccrefundlocate.js" type="text/javascript"></script>
</asp:Content>
        ...
        <tr>
            <td colspan="4">
                ...
                <cc1:jqGridAdv runat="server" ID="jqGridRelated" colNames="['ID','Cinvoice Num','Description','Date', 'DueDate', 'Net','Tax','Gross','Due','Paid']"
                    ...
                    width="700"
                    height="200"
                    url="ccrefundlocate.aspx/jqGridRelatedDataBind"
                    hasID="false"
                    multiselect="false"
                    editurl="ccrefundlocate.aspx/SaveDataFromGrid"
                    inlineNav="true"
                     addVisible="false"
        ...
        <tr>
            <td colspan="4">
                ...
                <cc1:jqGridAdv runat="server" ID="jqGridUnpaid" colNames="['ID','Cinvoice Num','Description','Date', 'DueDate', 'Net','Tax','Gross','Due']"
                    ...
                    width="700"
                    height="200"
                    url="ccrefundlocate.aspx/jqGridUnpaidDataBind"
                    hasID="false"
                    multiselect="true"
                    />
            </td>
