<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="receipteditM.aspx.cs" Inherits="sapp_sms.receipteditM" %>
        ...
        <div class="button">
            ...
            <div>
                <asp:ImageButton ID="ImageButtonNext" runat="server" 
                    ImageUrl="Images/goright.gif" OnClick="ImageButtonNext_Click" />
            </div>
        </div>
        <div class="button">
            <div class="button-title">
                ...
                <td colspan="4">
                    <asp:GridView ID="GridView1" CssClass="JQDataTable" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Bodycorp" HeaderText="Bodycorp" />
                            <asp:BoundField DataField="Unit" HeaderText="Unit" />
                            <asp:BoundField DataField="Date" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Date" />
                            <asp:BoundField DataField="Due" HeaderText="Due"  DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="Gross" HeaderText="Gross" />
                            <asp:BoundField DataField="Paid" HeaderText="Paid" />
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" IID='<%#Eval("ID") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
