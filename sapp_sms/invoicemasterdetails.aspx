<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="invoicemasterdetails.aspx.cs" Inherits="sapp_sms.invoicemasterdetails" %>

<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Invoice Master Details</title>
    ...
    <script src="scripts/invoicemasterdetails.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content_left">
        ...
        <div class="button">
            <div class="button-title">
                Copy & Add</div>
            <div>
                <asp:ImageButton ID="ImageButtonAdd" runat="server" ImageUrl="Images/new.gif" OnClick="ImageButtonCopyAdd_Click" />
            </div>
        </div>
        <div class="button">
            <div class="button-title">
    ...
    <div id="content_middle">
        <table class="details">
            <tr>
                <td>
                    <b>Invoice ID:</b><asp:Image ID="Image11" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td colspan="3">
                    <b>
            ...
            <tr>
                <td>
                    <b>Num :</b><asp:Image ID="Image2" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <b>Bodycorp:</b><asp:Image ID="Image4" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <b>Invoice Date :</b><asp:Image ID="Image6" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <b>Apply Date :</b><asp:Image ID="Image10" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td colspan="3">
            ...
            <tr>
                <td>
                    <b>Description</b><asp:Image ID="Image8" runat="server" Height="10px" ImageUrl="~/images/transparent.png" />
                </td>
                <td colspan="3">
                    ...
                    <div>
                        ...
                        <cc1:jqGridAdv runat="server" ID="jqGridTrans" colNames="['ID','Chart','Description','Net','Tax','Gross']"
                          ...
                          { name: 'Gross', index: 'Gross', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}},
                            ...
                            width="700" height="300" url="invoicemasterdetails.aspx/DataGridDataBind" hasID="true"
                            idName="invoicemasterid" footerrow="true" userDataOnFooter="true" />
                    </div>
                    <div>
    ...
    <script>
        function Rshow(id, type) {
            var url = "activityreciptdetail.aspx?id=" + id + "&type=Receipt";
        ...
        function show(id, type) {
            var url = "activityunitdetail.aspx?id=" + id + "&type=InvoiceDetail";
            vReturnValue = window.showModalDialog(url, "#1", "dialogHeight: 700px; dialogWidth: 850px; edge: Raised; center: Yes;" +
                    "help: No; resizable: No; status: No; scroll: No;");
            if (vReturnValue == "refresh") {
                __doPostBack('__Page', 'Refresh|0');
