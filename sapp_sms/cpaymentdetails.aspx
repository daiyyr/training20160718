<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="cpaymentdetails.aspx.cs" Inherits="sapp_sms.cpaymentdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_middle">
        <table class="details">
            <tr>
                <td>
                    <b>Cpayment:<asp:Image ID="Image11" runat="server" Height="10px" ImageUrl="~/images/transparent.png" /></b>
                </td>
                <td>
                    <b>
                ...
                <td colspan="4">
                    <div>
                        ...
                        { name: 'Paid', index: 'Paid', width: 100, align: 'left', search: true,  searchoptions: { sopt: ['cn', 'nc']}}
                            ...
                            viewrecords="true" width="700" height="200" url="cpaymentdetails.aspx/DataGridDataBind"
                            hasID="false" />
                    </div>
                </td>
            </tr>
