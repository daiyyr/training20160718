<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="accounts.aspx.cs" Inherits="sapp_sms.accounts" %>
<%@ Register TagPrefix="uc" TagName="jqGrid" Src="~/jqGrid.ascx" %>
<%@ Register Assembly="jqGridAdv" Namespace="jqGridAdv" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sapp SMS - Accounts</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content_left">
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDetails"
                runat="server" ImageUrl="Images/detail.gif" PostBackUrl="~/accounts.aspx"
        ...
        <div>
            <asp:ImageButton ID="ImageButtonEdit"
                runat="server" ImageUrl="Images/edit.gif" PostBackUrl="~/accounts.aspx"
        ...
        <div>
            <asp:ImageButton ID="ImageButtonDelete"
                runat="server" ImageUrl="Images/delete.gif" PostBackUrl="~/accounts.aspx"
    ...
    <div id="content_middle">
            <div>
                ...
                <cc1:jqGridAdv runat="server" ID="jqGridAccounts" colNames="['ID', 'Code', 'Name', 'Number']"
                 ...
                 width="700"
                 height="500"
                 url="accounts.aspx/DataGridAccountsDataBind"
                 hasID="true"
                 idName="menuid"
                 />
            </div>      
