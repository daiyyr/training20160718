...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="padding: 2px; margin-left: 20px; vertical-align: top;" border="1" 
        ...
        <tr valign="top">
            <td>39</td>
            <td align="left">
                <asp:DropDownList ID="DropDownListBodycorp39" runat="server" Width="220px"></asp:DropDownList>
                <asp:Button ID="Button39" runat="server" OnClick="Button39_Click" Text="Bodycorp Data Remover" />
            </td>
            <td align="left"><b>Important!</b> <br/>Remove all the data of selected bodycopy from table gl_transactions, gl_tran_gls, cinvoices, cinvoice_gls, invoices, invoice_gls, cpayments, cpayment_gls, receipts and receipt_gls.</td>
            <td>40</td>
            <td align="left"><asp:Button ID="Button40" runat="server" OnClick="Button40_Click"  Text="Check balance" /></td>
            <td align="left">Check the balance for all bodycorps in terms of the summary of &quot;transaction net&quot;.<br />Result is shown below.</td>
        </tr>
        <tr valign="top">
            <td>41</td>
            <td align="left"><asp:Button ID="Button41" runat="server" OnClick="Button41_Click" Text="Check BC code" /></td>
            <td align="left"><b>Important!</b> <br/>Check whether the bodycopy id of Invoice/Recipt/CreditNotes/Refund match the bodycopy id of the unit invoked in these transactions.<br />Result is shown below.</td>
            <td>42</td>
            <td align="left">
                <asp:Button ID="Button42" runat="server" OnClick="Button42_Click" Text="Check Allocatoin & Reversal of Journal" />
                <asp:Button ID="Button42_2" runat="server" OnClick="Button42_2_Click" Text="Remove allocated data" />
            </td>
            <td align="left"><b>Important!</b>Check whether a journal is allocated and reversed at the same time.<br />Result is shown below.</td>
        </tr>
        <tr valign="top">
            <td>43-1</td>
            <td align="left">
                <asp:Button ID="Button43_1" runat="server" OnClick="Button43_1_Click" Text="Check Reversal & Reconciliation" />
                <asp:DropDownList ID="DropDownList43" runat="server" Width="220px"></asp:DropDownList>
                <asp:Button ID="Button43_2" runat="server" OnClick="Button43_2_Click" Text="Reversed & Reconciliated Data Remover" />
            </td>
            <td align="left"><b>Important!</b>Check whether a journal is allocated and reconciliated at the same time.<br />Result is shown below.</td>
            <td>43-2</td>
            <td align="left"></td>
            <td align="left"></td>
        </tr>
